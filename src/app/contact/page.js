...
export default function ContactPage() {
  ...
  return (
    <div
      className="
 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 animate-fade-in "
    >
      {/* Header */}
      <div className="text-center space-y-2 max-w-xl mx-auto">
        ...
        <p className="text-xs text-gray-500 font-sans">
          Have a bulk order request, delivery query, or product feedback? Shoot
          us a message or contact us directly on WhatsApp.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-5xl mx-auto items-stretch">
        ...
        <div className="lg:col-span-5 bg-[#1E3A2F] text-white p-8 rounded-2xl flex flex-col justify-between space-y-8 shadow-md">
          <div className="space-y-6">
            <h3 className="text-xl font-bold font-serif text-[#FDFBF7]">
              Contact Details
            </h3>
            ...
            <ul className="space-y-4 text-xs font-sans text-gray-200">
              <li className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 text-[#C27D38] flex-shrink-0 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="hover:text-[#C27D38] transition-colors"
                >
                  +94 74 336 1612{" "}
                </a>
              </li>
          ...
          <div className="space-y-4 border-t border-white/10 pt-6 font-sans text-xs">
            ...
            <p className="text-[#C27D38] font-bold">
              Closed on Sundays & Poya Days
            </p>
          </div>

          <div className="pt-4 border-t border-white/10">
            <a
              href="https://wa.me/94743361612"
              target="_blank"
          ...
          {sent ? (
            <div className="text-center space-y-4 py-8 animate-fade-in">
              ...
              <p className="text-xs text-gray-500 max-w-xs mx-auto font-sans leading-relaxed">
                Thank you for contacting Anera Foods. A support representative
                will review your inquiry and get back to you shortly.
              </p>
              <button
                onClick={() => setSent(false)}
                className="btn text-white bg-[#C27D38] py-2 px-5 text-xs mt-2"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full p-2.5 text-black text-xs border rounded-lg focus:outline-none focus:border-[#C27D38] font-sans ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full p-2.5 text-black text-xs border border-gray-200 rounded-lg focus:outline-none focus:border-[#C27D38] font-sans"
